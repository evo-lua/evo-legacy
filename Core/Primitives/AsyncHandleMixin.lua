...
function AsyncHandleMixin:IsActive() return self.handle:is_active() end

function AsyncHandleMixin:IsClosing() return self.handle:is_closing() end

function AsyncHandleMixin:Close() return self.handle:close() end

function AsyncHandleMixin:Reference() return self.handle:ref() end

function AsyncHandleMixin:Unreference() return self.handle:unref() end

function AsyncHandleMixin:HasReference() return self.handle:has_ref() end
...
function AsyncHandleMixin:GetReadOnlyFileDescriptor() return self.handle:fileno() end
