...
local function StringMatchBackwards(subject, pattern, idx)
...
local function StringLastIndexOf(sub, pat, index)
...
local function StringPrototypeLastIndexOf(sub, pat, position)
