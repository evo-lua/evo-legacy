...
local websocketHandler = import("@creationix/weblit-websocket/weblit-websocket.lua")

dump(websocketHandler)
assert(type(websocketHandler) == "function", "Should import the weblit-websocket package")
